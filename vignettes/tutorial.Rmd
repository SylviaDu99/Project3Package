...
my_t
```
According to the boxplot and the table, as k increases, the range of mse, the standard deviation, the median and mean are tending to increase. Because the more folds exist, the more we can evaluate the data, and our prediction would be more accurate as the MSE and standard deviation decrease due to the decrease of variance.
